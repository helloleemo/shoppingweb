...
export default {
  ...
  methods: {
    getOrders(currentPage = 1) {
      ...
      const url = `${import.meta.env.VITE_PATH_API}api/${import.meta.env.VITE_PATH_APP}/admin/orders?page=${currentPage}`
      this.isLoading = true
    ...
    updatePaid(item) {
      this.isLoading = true
      const api = `${import.meta.env.VITE_PATH_API}api/${import.meta.env.VITE_PATH_APP}/admin/order/${item.id}`
      const paid = {
    ...
    delOrder() {
      const url = `${import.meta.env.VITE_PATH_API}api/${import.meta.env.VITE_PATH_APP}/admin/order/${this.tempOrder.id}`
      this.isLoading = true
  ...
  created() {
    this.getOrders()
    console.log(import.meta.env.VITE_PATH_API)
  }
}
</script>
